        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde una perspectiva amplia e interconectada, comprender cómo se relaciona la economía colombiana con el entorno global se convierte en una competencia clave para analizar la realidad del país. En esta unidad, se examina la estructura interna de la economía nacional, identificando los sectores que impulsan el crecimiento, los desafíos estructurales como la informalidad y la desigualdad, y el papel del Estado en la formulación de políticas económicas.
              
              p #[b ¡Prepárese para comprender la economía desde una mirada global y proponer soluciones a los desafíos que enfrenta Colombia en un mundo interdependiente!]
